...
import styles from './StaffPageAccordionLayoutGeneric.module.scss';

function StaffPageAccordionLayoutGeneric(props) {
...
export default StaffPageAccordionLayoutGeneric;
