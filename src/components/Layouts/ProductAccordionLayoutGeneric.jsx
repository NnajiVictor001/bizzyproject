...
import styles from './ProductAccordionLayoutGeneric.module.scss';

function ProductAccordionLayoutGeneric(props) {
        ...
        <Fragment key={index}>
          <div
            ...
            <div className={settings_item__con}>
              {item.completed && !item.select ? (
                <InputCheckbox checked label={item.title} readOnly />
              ) : item.select ? (
                <>
...
export default ProductAccordionLayoutGeneric;
